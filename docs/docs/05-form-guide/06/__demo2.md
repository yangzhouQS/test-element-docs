...
const tableConfig = computed(() => {
  return [
    { attr: { prop: 'code', type: 'index', label: '序号', width: 80, align: 'center', fixed: 'left' } },
    { attr: { prop: 'column1', label: 'column1', width: 220, scopedSlot: 'column1' } },
    { attr: { prop: 'column2', label: 'column2', width: 220, scopedSlot: 'column2' } },
    { attr: { prop: 'column3', label: 'column3', width: 200, scopedSlot: 'column3' } },
    { attr: { prop: 'column4', label: 'column4', width: 200, scopedSlot: 'column4' } },
    { attr: { prop: 'column5', label: 'column5', width: 150, scopedSlot: 'column5' } },
    { attr: { prop: 'column6', label: 'column6', width: 150, scopedSlot: 'column6', fixed: 'right' } },
  ];
});
const dataMap = {
  dataSource1: [

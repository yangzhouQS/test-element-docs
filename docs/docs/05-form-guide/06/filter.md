...
<template>
  ...
  <div style="height:500px;overflow: hidden;">
    <table-edit-v2
      ...
      <template #column1FilterSlot="{column}">
...
const tableConfig = computed(() => {
  return [
    ...
    { attr: { prop: 'column1', label: 'column1', width: 120, sortable: true, scopedSlot: 'column1', filterSlot: 'column1FilterSlot'
    , filters: ageOptions.value
    , filterMethod: filterAgeMethod } },

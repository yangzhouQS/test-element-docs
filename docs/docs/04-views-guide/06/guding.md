...
const tableConfig = computed(() => {
  return [
    { attr: { prop: "code", type: 'index', label: "序号", width: 120, treeNode: true, fixed: 'left' } },
    { attr: { prop: "name", label: "Name", width: 120, fixed: 'left'  } },
    { attr: { prop: "size", label: "Size", width: 220 } },
    { attr: { prop: "size", label: "Size", width: 220 } },
    { attr: { prop: "type", label: "Type", width: 220   } },
    { attr: { prop: "size", label: "Size", width: 120 , fixed: 'right'} },

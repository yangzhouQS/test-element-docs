...
<template>
  <div style="height:400px;">
    <tree-table
      ...
      <template #typeheader>
        <el-tag type="primary">标题自定义</el-tag>
      </template>
      <template #groupheader>
        <el-tag type="primary">分组标题自定义</el-tag>
      </template>
    </tree-table>
  </div>
</template>
...
const tableConfig = computed(() => {
  return [
    { attr: { prop: "code", type: 'index', width: 120, label: "序号", treeNode: true } },
    { attr: { prop: "name", label: "Name", width: 120 } },
    { attr: { prop: "type", label: "Type", width: 120, scopedSlot: 'type', headerSlot: 'typeheader'   } },
    {
      isParent: true,
      attr: {label: '分组', headerSlot: 'groupheader' },
      items: [
